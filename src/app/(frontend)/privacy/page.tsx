      ...
      <main className={a.main}>
        <article className={l.prose}>
          ...
          <p>
            ...
            name, email, phone, base postcode, the counties you cover, and a record
            of the jobs you open. This is visible to our administrators and used to
            match you to jobs. Your business details are not shared with customers
